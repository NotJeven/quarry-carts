...
title @a[team=!team1,score_currentColour_min=1,score_currentColour=1] subtitle [{"text":"Welcome to ","color":"white"},{"text":"BLUE","color":"blue"},{"text":".","color":"white"}]
title @a[team=!team1,score_currentColour_min=1,score_currentColour=1] title ""
playsound entity.horse.armor master @a[team=!team1,score_currentColour_min=1,score_currentColour=1] ~ ~ ~ 100 1 1
