...
playsound mob.horse.armor @a[team=!team2,score_currentColour_min=2,score_currentColour=2] 0 100 0 100 1 1
...
execute @e[type=Item,name=gameRunning,score_var_min=2,score_var=2] ~ ~ ~ scoreboard players set @a[team=!,score_inGame_min=0,score_inGame=0] midJoin 1


# when a player needs items
