...
playsound entity.zombie_villager.converted master @a[score_sinceDeath_min=200,score_respawn_min=2,score_respawn=2,score_inGame_min=1,score_inGame=1] ~ ~ ~ 100 1 1
