...
tellraw @a[score_inGame_min=-1,score_inGame=-1] [{text:"Version: "},{text:"v0.4",color:yellow}]
tellraw @a[score_inGame_min=-1,score_inGame=-1] {text:""}
tellraw @a[score_inGame_min=-1,score_inGame=-1] [{text:"Learn more about "},{text:"Quarry Carts",color:purple,underlined:true,clickEvent:{action:open_url,value:http://jevenlabs.net/qc},hoverEvent:{action:show_text,value:"Visit Quarry Carts website."}},{text:"."}]
title @a[score_inGame_min=-1,score_inGame=-1] times 20 60 20
title @a[score_inGame_min=-1,score_inGame=-1] subtitle [{text:"By Jeven"}]
title @a[score_inGame_min=-1,score_inGame=-1] title [{text:"Quarry Carts",color:yellow}]
# set scores
